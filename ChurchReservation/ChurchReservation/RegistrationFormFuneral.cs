...
namespace ChurchReservation
{
    public partial class RegistrationFormFuneral : Form
    {
        ...
        public string registrationFormFuneral;
        ...
        {
            con.Open();
            com = new MySqlCommand("SELECT MAX(RegistrationID)as maxid FROM tbl_registrationfuneral", con);
        ...
        {
            textBox1.Text = registrationFormFuneral;
            connection();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                com = new MySqlCommand("Select * from tbl_registrationfuneral WHERE RegistrationID = '" + registrationid.Text + "'", con);
                data = com.ExecuteReader();
                ...
                con.Open();
                com = new MySqlCommand("insert into db_reservation.tbl_registrationfuneral(RegistrationID,Firstname,Lastname,Requirements,Fillup,Payment) values ('" + registrationid.Text + "','" + firstnametx.Text + "','" + lastnametx.Text + "','" + x + "','" + x + "','" + x + "')", con);
                com.ExecuteNonQuery();
                con.Close();

                con.Open();
                com = new MySqlCommand("insert into db_reservation.tbl_fun(Contact)values ('" + registrationid.Text + "')", con);
                com.ExecuteNonQuery();
                con.Close();


                RegistrationListFuneral maa = new RegistrationListFuneral();
                maa.registrationlistfuneral = textBox1.Text;
                maa.Show();
                this.Hide();
            }
        }
