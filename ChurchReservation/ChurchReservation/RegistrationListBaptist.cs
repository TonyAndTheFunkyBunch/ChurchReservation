...
{
    public partial class RegistrationListBaptist : Form
    {
        MySqlConnection con;
        MySqlCommand com;
        ...
        public string registrationlistbaptist;



        public RegistrationListBaptist()
        {
            InitializeComponent();
        }
        ...
        public void selection()
        {
            ...
            con.Open();
            com = new MySqlCommand("Select * from tbl_registrationbaptist", con);
        ...
        private void RegistrationListBaptist_Load(object sender, EventArgs e)
        {
            textBox1.Text = registrationlistbaptist;
            connection();
            selection();
        }
        ...
        private void listView1_ItemActivate(object sender, EventArgs e)
        {
            ...
            {
                Baptist eee = new Baptist();
                eee.baptist = textBox1.Text;
                eee.res = contactno.Text;
                eee.Show();
                this.Hide();
            }
        }
        ...
        {
            RegistrationFormBaptist rfb = new RegistrationFormBaptist();
            rfb.registrationFormbaptist = textBox1.Text;
            rfb.Show();
            this.Hide();
        }
